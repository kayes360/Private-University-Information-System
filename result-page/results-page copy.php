...
<body>
		...
		<div class="left_form">
			<fieldset id="form_fieldset">
				<form class="sideform" method="POST" action="">
					...
					<input type="range" name='total_cost' id="fee_range" value="500000" min="0" max="1000000"
						step="50000" onchange="showMaxFee(this.value);">
					<br />
	...
	<?php 
			if ( $result ) {
				...
				while($_SESSION['row'] = mysqli_fetch_object($result)) { ?>
	<div class="container" id="card_section">
		<div class="card">
			...
			<div class="university_name">
				...
				<h5 class="card-title">
					<?php echo $_SESSION['row']->University_Name ?> (<?php echo $_SESSION['row']->University_Initial ?>)
				</h5>
			</div>
			<div class="container" id="card_container">
				<div class="card-body">
					...
					<div class="contact"> <i class="fas fa-phone-square" style=" transform: rotate(90deg);"></i> <span>
							<?php echo $row->Contact_No ?></span>
					</div>
